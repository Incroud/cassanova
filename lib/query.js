    ...
    if(paramsIsSchemaType && valueIsArray){
        ...
        if(!valueIsArray){
            ...
            for(i=0; i < valueArr.length; i++){
                ...
                value[keyProp] = keyParams.key.type === "text" ? value[keyProp].replace(/'/g, "''") : value[keyProp];
            ...
            for(i=0; i<value.length; i++){
                ...
                value[i][keyProp] = keyParams.key.type === "text" ? value[i][keyProp].replace(/'/g, "''") : value[i][keyProp];
