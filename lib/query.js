...
Query.prototype.wrapKeyValue = function(key, value){
    ...
    if(keySchema.type === 'text' && typeof value === 'string'){
    ...
    if(paramsIsSchemaType && valueIsArray){
        ...
        for(i=0; i<value.length; i++){
            ...
            value[i] = keyParams.type === 'text' ? value[i].replace(/'/g, "''") : value[i]
        ...
        if(!valueIsArray){
            ...
            for(i=0; i < valueArr.length; i++){
                ...
                keyProp = keyParams.key.type === "text" ? keyProp.replace(/'/g, "''") : keyProp;
                value[keyProp] = keyParams.key.type === "text" && typeof value[keyProp] === 'string' ? value[keyProp].replace(/'/g, "''") : value[keyProp];
            ...
            for(i=0; i<value.length; i++){
                ...
                keyProp = keyParams.key.type === "text" ? keyProp[0].replace(/'/g, "''") : keyProp[0];
                value[i][keyProp] = !value[keyProp] && keyParams.key.type ? value[i][keyProp].replace(/'/g, "''") : value[i][keyProp];
